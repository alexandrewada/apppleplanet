<div class="col-md-12 col-sm-12 col-xs-12">
  <div class='alert alert-info'>
    Acompanhe em tempo real o que está acontecendo com o seu aparelho na assistência.
  </div>
  <div class="x_panel">
    <div class="x_title">
      <h2>Acompanhamento de Ordem de Serviço</h2>
    ...
    <div class="x_content">
      ...
      <ul class="list-unstyled timeline widget">
        <?foreach ($acompanhamento as $key => $v):?>
