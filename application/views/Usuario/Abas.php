		...
		<div class="x_content">
			<div class="" role="tabpanel" data-example-id="togglable-tabs">
				<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
					...
					<li role="presentation">
						<a href="#editar_usuario" id="home-tab" role="tab"  data-url="<?=base_url('os/vinculadas/'.$id_usuario);?>" data-toggle="tab" aria-expanded="true">O.S Vinculadas <b>(<?=$os_vinculadas;?>)</b> </a>
					</li>
