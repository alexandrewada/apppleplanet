                  ...
                  <div class="x_content">
                    ...
                    <form  id="ajaxForm" action='<?=base_url('usuario/editar/'.$usuario->id_usuario.'');?>'' method='POST' class="form-horizontal form-label-left" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12">
                          <select  name='tipo_usuario'  class="form-control col-md-7 col-xs-12">
                            ...
                            <option <?=($usuario->tipo_usuario == 'pj') ? 'selected' : '';?> value='pj'>Pessoa Jurídica</option>
                            <option <?=($usuario->tipo_usuario == 'pf') ? 'selected' : '';?> value='pf'>Pessoa Física</option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12">
                          <input type="text" name='ie'  data-inputmask="'mask': '999.999.999.999'" value='<?=$usuario->ie;?>' class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input type="text" name='cnpj' value='<?=$usuario->cnpj;?>' data-inputmask="'mask': '99.999.999/9999-99'"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                    ...
                    <div class="x_title">
                      ...
                      <div id='aposCEP'>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-6 col-xs-12">
                            <input  type="text" name='complemento'  value='<?=$usuario->complemento;?>'  class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>
