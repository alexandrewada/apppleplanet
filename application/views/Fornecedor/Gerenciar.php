		...
		<div class="x_content">
			...
			<table id="tabela" class="ui celled table" cellspacing="0" width="100%">
		      ...
		      <tfoot>
		        ...
		        <tbody>
		       		<?foreach ($Listarfornecedores as $key => $v):?>
		       			<tr>
		       				<td><?=$v->id_fornecedor;?></td>
		       				<td><?=$v->nome;?></td>
		       				<td style="text-align: center;"><i onclick="modalAjax('<?=base_url('fornecedor/editar/'.$v->id_fornecedor.'');?>');" class="fa fa-edit"></i></td>
...
<script type="text/javascript">
	...
	var table = $('#tabela ').DataTable({dom: 'Bfrtip',
        buttons: [
