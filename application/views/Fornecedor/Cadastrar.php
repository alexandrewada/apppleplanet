<script src="<?=base_url();?>public/js/fornecedor/cadastrar.js"></script>
...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form  id="ajaxForm" action='<?=base_url('fornecedor/cadastrar');?>'' method='POST' class="form-horizontal form-label-left" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <input type="text" name='email' placeholder='Ex: fornecedor@apple.com.br' class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
