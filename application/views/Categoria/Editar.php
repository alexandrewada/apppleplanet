...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form  id="ajaxForm" action='<?=base_url('categoria/editar/'.$Categoria->id_categoria.'');?>'' method='POST' class="form-horizontal form-label-left" >
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nome da Categoria<span class="required">*</span>
                        </label>
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <input type="text" name='nome_categoria' value='<?=$Categoria->nome;?>' placeholder='Ex: Acessórios para Celular' class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
