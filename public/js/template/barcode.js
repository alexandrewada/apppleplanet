...
(function ($) {
  ...
  var barcode = {
    ...
    digitToCssRenderer : function($container, settings, digit, hri, mw, mh){
      ...
      if (settings.showHRI){
        content += "<div style=\"clear:both; width: 100%; background-color: " + settings.bgColor + "; color: " + settings.color + "; text-align: center; font-size: 15px; margin-top: " + settings.marginHRI + "px;\">"+hri+'<br><span style="font-size: 16px;"><b>'+settings.produto+"</b><br><b>R$ "+settings.preco+"</b></span></div>";
      }
